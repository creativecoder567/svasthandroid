...
if ($SESSION=='Morning') {
  //echo $SESSION;
  $sql="select * from litre WHERE userid = '$USERID' AND  orderid ='$ORDERID' AND active_m ='0'  ";
  ...
  //echo $SESSION;
    $sql="select * from litre WHERE userid = '$USERID' AND  orderid ='$ORDERID'  AND active_e ='0' ";
    $result=mysqli_query($db,$sql);
